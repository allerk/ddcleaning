        ...
        <>
            ...
            <form className="row calculator">
                ...
                <div className="col-md-12">
                    <label style={{paddingTop: "30px"}}>Additional services</label>
                ...
                <div className="col-md-3">
                    <label style={{paddingTop: "30px", paddingBottom: "5px"}}>Public contract:</label>
                    <div className="form-check">
                        <input className="form-check-input shadow-none" type="checkbox" id="gridCheck"/>
                        <label className="form-check-label" htmlFor="gridCheck">
                            I agree <a href="https://smilecleaning.ee/wp-content/uploads/2019/09/dogovor-en.pdf" target="_blank">with the contract</a>
                        </label>
                    </div>
                </div>
                <div className="col-md-9">
                    <label style={{paddingTop: "30px"}}>Coupon:</label>
                    <div className="form-group">
                        ...
                        {/*<input type="submit" value="Send" className="promo-button"/>*/}
                    </div>
                </div>
                <div className="col-md-3">
                    <label className="estimated" style={{paddingTop: "30px"}}>Estimated amount:</label>
                    <h3 className="text-md-start">65.00$</h3>
                </div>
