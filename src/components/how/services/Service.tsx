...
const Service = () => {
    return(
        <div className="service-block">
            ...
            <div className="row align-services">
                <div className="col-md-4">
                    ...
                    <img src={picture1} className="d-inline-block img-fluid mb-4 br-1"/>
                </div>
                <div className="col-md-4">
                    <img src={picture1} className="d-inline-block img-fluid mb-4 br-2"/>
                    <div className="row">
                        <div className="col-md-8">
